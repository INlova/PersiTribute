...
this.hc&&(b+="&enablejsapi=1&html5=1&controls=0",c='<div id="video-controls"><div id="video-progress" class="video-progress-el"><div id="video-progress-total" class="video-progress-el"></div><div id="video-elapsed" class="video-progress-el"></div></div><div id="video-time" class="video-progress-el"></div></div>')):this.fc&&(b="//player.vimeo.com/video/"+this.fc+"?autoplay=1&title=0&byline=0&portrait=0");if(this.W)this.Gd='<iframe id="'+g.w+'-video-frame" width="'+this.ka+'" height="'+this.X+'"  src="'+
